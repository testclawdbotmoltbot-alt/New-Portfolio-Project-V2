...
import { Eye, EyeOff, Lock, Mail, Cpu, ArrowRight, AlertCircle } from 'lucide-react';
      ...
      >
        ...
        <div className="text-center mb-8">
          <motion.div
            ...
            className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-neon-cyan to-neon-purple mb-4"
          >
        ...
        {/* Login Form */}
        <div className="glass-panel rounded-2xl border border-neon-cyan/30 p-8">
          {/* Security Badge */}
          <div className="flex items-center justify-center gap-2 mb-6">
            <div className="w-2 h-2 rounded-full bg-neon-green animate-pulse" />
            <span className="text-xs font-mono text-neon-green">ENCRYPTED_CONNECTION</span>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 bg-cyber-dark/50 border-neon-cyan/30 text-white placeholder:text-muted-foreground focus:border-neon-cyan"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  required
                  placeholder="••••••••"
                  className="pl-10 pr-10 bg-cyber-dark/50 border-neon-cyan/30 text-white placeholder:text-muted-foreground focus:border-neon-cyan"
                />
                <button
                  type="button"
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-neon-cyan to-neon-blue text-cyber-dark font-bold py-6 hover:shadow-glow-cyan transition-all duration-300"
            >
              {isLoading ? (
                <motion.div
                  animate={{ rotate: 360 }}
        ...
        <div className="mt-8 text-center">
          <p className="text-xs text-muted-foreground font-mono">
            SECURE_CONNECTION • AES-256_ENCRYPTION
          </p>
        </div>
      </motion.div>
    </div>
